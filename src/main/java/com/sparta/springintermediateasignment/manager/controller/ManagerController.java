...
public class ManagerController {
    ...
    public ResponseEntity<Void> addScheduleManager(@Valid @RequestBody AddScheduleManagerDto userDto) {
    ...
    public ResponseEntity<Void> deleteScheduleManager(@Valid @RequestBody RemoveSchedueManagerDto userDto) {
